...
class User(db.Model):
    ...
    email = db.Column(db.String(120), nullable=False, unique=True, default='')
    phone = db.Column(db.String(20), nullable=False, unique=True, default='')
    role = db.Column(db.String(10), nullable=False, default='')  # 'tenant' or 'landlord'
